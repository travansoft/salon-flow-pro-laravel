        ...
        <form action="{{ $tenantUrl->route('services.update', $service) }}" method="POST">
            ...
            <div class="sfp-split-2">
                <div class="sfp-field">
                    ...
                    <input type="number" step="0.01" min="0" id="service-price-inclusive" class="sfp-input" data-exclusive="{{ old('price', $service->price) }}">
                    <input type="hidden" name="price" id="service-price-exclusive" value="{{ old('price', $service->price) }}">
